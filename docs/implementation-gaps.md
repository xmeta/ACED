...
- WJS canonical validator availability is fail-closed: missing or unusable WJS validation no longer downgrades to a permissive local fallback, and `doctor` reports the same repair boundary
